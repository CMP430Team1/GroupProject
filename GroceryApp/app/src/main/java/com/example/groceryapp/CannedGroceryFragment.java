...
public class CannedGroceryFragment extends Fragment implements GroceryListAdapter.onGroceryItemListener{
...
//    /*final*/ GroceryListAdapter adapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.canneditems_fragment, container, false);
        recyclerView = view.findViewById(R.id.canned_recyclerView);
        return view;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mGroceryViewModel.getAllCannedItems().observe(getActivity(), new Observer<List<GroceryItem>>() {
            @Override
